---
title: "I chose the best title the World has never seen"
author:
- affiliation: SciencesPo Au bord de l'Eau
  name: Julie Desquilbet
...
keywords: yep, nop, maybe, maybenot, certainly
bibliography: references.bib
abstract: This document serves as a template that you can reuse with your own projects.  The
  goal is to illustrate some of the functionalities of R, LaTeX, and Rmarkdown to
  conduct end-to-end academic research projects. You will also use this template for
  some of the course assignments and also to do your research project. There are many
  different moving pieces when you use this document for the first time. Don't worry
...
# Introduction
Templates are very useful for students because they allow them to devote more time to the substance than to the form of their work...or to spend less time working at all.... `r lorem::ipsum(2, avg_words_per_sentence = 15)`
...
```{r, eval=TRUE, echo=FALSE, size="small", fig.cap="Woo, I'm impressed, this figure seems unreal.", out.width="75%", fig.align="center"}
library(tidyverse)
library(anesr)
...
[^one_footnote]: When the footnotes are really long...I confess that I often get lazy reading them. 
